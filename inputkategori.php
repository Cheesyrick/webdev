            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Input Kategori Wisata</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Menginput data kategori wisata disini</li>
                        </ol>
  ...
  <head>
    ...
    <form method="POST">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="kategorikode" name="inputKategoriNama" placeholder="Inputkan Kode Kategori">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="kategorikode" name="inputKategoriKet"placeholder="Inputkan Kode Kategori">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="kategorikode" name="inputKategoriRef" placeholder="Inputkan Kode Kategori">
            </div>
        </div>
    ...
    <?php
        ...
        {
            $search = $_POST["search"];
            $query = mysqli_query($connection,"select kategoriwisata.* from kategoriwisata where kategoriNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
        }
        else
        {
