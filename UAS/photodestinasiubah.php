...
<?php
	...
	$editkode = mysqli_query($connection, "SELECT * FROM fotodestinasi, destinasik WHERE fotodestinasiKODE = '$fotodestinasiKODE' AND fotodestinasi.destinasiKODE = destinasik.destinasiKODE");
