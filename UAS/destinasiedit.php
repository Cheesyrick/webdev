...
<?php
    ...
    if(isset($_POST["edit"]))
    {
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            "UPDATE destinasik SET destinasiNAMA = '$destinasiNAMA', 
            destinasiKET = '$destinasiKET', 
            kategoriKODE = '$kategoriKODE', 
            fotodestinasi = '$fotodestinasi' 
    ...
    $editdestinasi = mysqli_query($connection, "SELECT * FROM destinasik WHERE destinasiKODE = '$destinasiKODE'");
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            if (isset($_POST['kirim'])) {
                $search = $_POST['search'];
                $query = mysqli_query ($connection, "SELECT destinasik.* FROM destinasik WHERE destinasiNAMA LIKE '%".$search."%'");
            } else {
                $query = mysqli_query ($connection,"SELECT destinasik.* FROM destinasik");
            }
            $nomor = 1;
