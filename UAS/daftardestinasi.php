...
<body>
    ...
    <div class="jumbotron mt-5">
        <h2 class="display-5">Daftar data Destinasi</h2>
    </div>
    ...
    <?php 
        ...
        {
            $search = $_POST["search"];
            $query = mysqli_query($connection,"select * from destinasik, kategoriwisata where destinasiNAMA like '%".$search."%' and destinasik.kategoriKODE = kategoriwisata.kategoriKODE");
        }
        else 
        {
            $query = mysqli_query($connection,"select * from destinasik, kategoriwisata where destinasik.kategoriKODE = kategoriwisata.kategoriKODE");
        }
